    ...
    <Router>
      ...
      <Routes>
        ...
        <Route
          ...
          element={<PrivateRoute element={<PlannedExerciseList />} />}
        />
        <Route
          path="/add-planned"
        ...
        <Route
          path="/add-workout"
          element={<PrivateRoute element={<AddWorkout />} />}
        />
        <Route
        ...
        <Route
          path="/exercise-logs"
          element={<PrivateRoute element={<ExerciseLogs />} />}
        />
        <Route
          path="/profile"
        ...
        <Route
          ...
          element={
            authState.isAuthenticated ? (
              <Navigate to="/planned-exercises" replace />
            ) : (
