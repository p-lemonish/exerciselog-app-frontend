...
import { Button, Container, Typography, List, ListItem, ListItemText, IconButton, Divider, Alert, CircularProgress, Box } from "@mui/material";
...
function PlannedExerciseList() {
    ...
    return (
        <Container maxWidth="md">
            ...
            <Button type="submit" color="primary" variant="contained" startIcon={<AddIcon />} onClick={handleAddExercise} fullWidth>
                Add New Exercise
            </Button>
            {error && (
